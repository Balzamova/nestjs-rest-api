    ...
    canActivate(context) {
        try {
            ...
            if (bearer !== 'Bearer' || !token) {
                throw new common_1.UnauthorizedException({ message: 'User has not autorized' });
            }
            ...
            console.log(e);
            throw new common_1.HttpException('User don`t have permissions', common_1.HttpStatus.FORBIDDEN);
        }
    }
};
